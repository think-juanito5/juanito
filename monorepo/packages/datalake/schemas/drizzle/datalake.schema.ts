...
// import { Column, PrimaryGeneratedColumn } from '@drizzle/typeorm';
...
export type SelectConveyancingPaymentSchema =
  typeof conveyancingPayment.$inferSelect

export const insertConveyancingPaymentSchema =
  createInsertSchema(conveyancingPayment)
export type InsertConveyancingPaymentSchema =
  typeof conveyancingPayment.$inferInsert
...
export const conveyancingService = pgTable('ConveyancingService', {
  ...
  matterId: integer('MatterID').unique(),
  assignedTo: varchar('AssignedTo', { length: 255 }),
  propertyId: integer('PropertyID'),
  isMovingIn: boolean('IsMovingIn'),
  mortgage: varchar('Mortgage', { length: 255 }),
...
export const selectConveyancingServiceSchema =
  createSelectSchema(conveyancingService)
...
export const dataInput = pgTable('DataInput', {
  ...
  sourceIpAddress: text('SourceIPAddress'),
  ...
  updated: timestamp('Updated', { mode: 'string' }).$onUpdate(() =>
    new Date().toLocaleString('en-US', { timeZone: 'Australia/Melbourne' }),
  ),
})
export const insertDataInputSchema = createInsertSchema(dataInput)
export type InsertDataInputSchema = typeof dataInput.$inferInsert
...
export const insertDocumentTypeSchema = createInsertSchema(documentType)
export type InsertDocumentTypeSchema = typeof documentType.$inferInsert
...
export const insertDeveloperLogSchema = createInsertSchema(developerLog)
export type InsertDeveloperLogSchema = typeof developerLog.$inferInsert
...
export const leadCampaignTrigger = pgTable('LeadCampaignTrigger', {
  ...
  updated: timestamp('Updated', { mode: 'string' }),
  deleted: timestamp('Deleted', { mode: 'string' }),
  isOnlineConversion: boolean('IsOnlineConversion'),
})
export const insertLeadCampaignTriggerSchema =
  createInsertSchema(leadCampaignTrigger)
export type InsertLeadCampaignTriggerSchema =
  typeof leadCampaignTrigger.$inferInsert
...
export const insertPropertyHelperApplicationSchema = createInsertSchema(
  propertyHelperApplication,
)
export type InsertPropertyHelperApplication =
  typeof propertyHelperApplication.$inferInsert
...
export const insertMovingHubLogSchema = createInsertSchema(movingHubLog)
export type InsertMovingHubLog = typeof movingHubLog.$inferInsert
...
export const insertOtoLinkingSchema = createInsertSchema(otoLinking)
export type InsertOtoLinking = typeof otoLinking.$inferInsert
...
export const insertRacvMembershipSchema = createInsertSchema(racvMembership)
export type InsertRacvMembershipSchema = typeof racvMembership.$inferInsert
...
export const propertyTransactionHistorySchema = createInsertSchema(
  propertyTransactionHistory,
)
export type PropertyTransactionHistorySchema =
  typeof propertyTransactionHistorySchema
...
export const insertPropertyTransactionSchema =
  createInsertSchema(propertyTransaction)
export type InsertPropertyTransactionSchema =
  typeof propertyTransaction.$inferInsert
...
export const transactionServiceHistory = pgTable('TransactionServiceHistory', {
  ...
  leadJourney: varchar('LeadJourney', { length: 30 }),
  sourceSystem: varchar('SourceSystem', { length: 50 }),
  raqId: varchar('RaqID', { length: 50 }),
})
export const transactionServiceHistorySchema = createInsertSchema(
  transactionServiceHistory,
)
export type TransactionServiceHistorySchema =
  typeof transactionServiceHistory.$inferInsert
...
export const insertTransactionServiceSchema =
  createInsertSchema(transactionService)
export type InsertTransactionServiceSchema =
  typeof transactionService.$inferInsert
export const selectTransactionServiceSchema =
  createSelectSchema(transactionService)
...
export const userProfileHistorySchema = createInsertSchema(userProfileHistory)
export type UserProfileHistorySchema = typeof userProfileHistory.$inferInsert
...
export const userSegmentHistorySchema = createInsertSchema(userSegmentHistory)
export type UserSegmentHistorySchema = typeof userSegmentHistory.$inferInsert
...
export type InsertUserProfileSchema = typeof userProfile.$inferInsert
...
export const insertUserIdentitySchema = createInsertSchema(userIdentity)
export type InsertUserIdentitySchema = typeof userIdentity.$inferInsert
...
export const insertUserSegmentSchema = createInsertSchema(userSegment)
export type InsertUserSegmentSchema = typeof userSegment.$inferInsert
...
export const userSubscriptionHistorySchema = createInsertSchema(
  userSubscriptionHistory,
)
export type UserSubscriptionHistorySchema =
  typeof userSubscriptionHistory.$inferInsert
...
export type InsertUserSubscriptionSchema = typeof userSubscription.$inferInsert
...
export const state = pgTable('State', {
  ...
  isOnlineConversion: boolean('IsOnlineConversion').default(false).notNull(),
})
...
export type SelectLeadsSchema = typeof leads.$inferSelect

export const insertLeadsSchema = createInsertSchema(leads)
export type InsertLeadsSchema = typeof leads.$inferInsert
