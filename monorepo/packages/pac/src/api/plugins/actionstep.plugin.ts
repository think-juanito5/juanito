...
import { PACActionStepService } from '../../pac.actionstep.service'
...
export const createPacActionstepService = (
  tenant: Tenant,
  headers: Record<string, string | undefined>,
  logger: Logger,
  correlationId?: string,
) => {
  const as = createActionstepService(tenant, headers, logger, correlationId)
  return new PACActionStepService(as, logger)
}
