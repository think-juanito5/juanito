...
export const factBasecheck = silverSchema.table('fact_basecheck', {
  ...
  businessDaysToComplete: integer('business_days_to_complete'),
  businessDaysCompletedBeforeSettlement: integer(
    'business_days_completed_before_settlement',
  ),
  created: timestamp('created', { withTimezone: true, mode: 'string' })
    .defaultNow()
    .notNull(),
  modified: timestamp('modified', { withTimezone: true, mode: 'string' })
    .defaultNow()
    .notNull(),
  baseCheckStatus: text('base_check_status'),
  businessDaysReadyBeforeSettlement: integer(
    'business_days_ready_before_settlement',
  ),
  baseCheck2Status: text('base_check2_status'),
